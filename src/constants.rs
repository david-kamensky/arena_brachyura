...
pub static PL_PROJ_LIGHT_COLOR: SVector::<f32,3> = SVector::<f32,3>::new(0.0,1.0,0.0);
pub static PL_PROJ_LIGHT_LENGTH: f32 = 2e3;
...
pub static MONSTER_DEAD_LIGHT_COLOR: SVector::<f32,3> = SVector::<f32,3>::new(1.0,0.75,0.0);
pub static MONSTER_DEAD_LIGHT_LENGTH: f32 = 5e3;
pub static MONSTER_SPAWN_LIGHT_COLOR: SVector::<f32,3> = SVector::<f32,3>::new(0.0,1.0,1.0);
pub static MONSTER_SPAWN_LIGHT_LENGTH: f32 = 3e3;
pub static DAMAGE_IMPULSE: f32 = 2.5;
pub static DEATH_TIME: i32 = 300;
pub static SPAWN_TIME: i32 = 300;
pub static SCORE_INCREASE: f32 = 0.1;
pub static SCORE_BASE_DECREASE: f32 = 0.1;
